...
pub type SymbolTable = Vec<(usize, HashMap<String, (Type, usize, bool, (Option<usize>, Option<usize>), )>)>; // Type, pushed with, has been declared in this scope, location(s) stored at
